...
<html>
	...
	<body>
		...
		<a href="<c:url value='/imageFileUploadForm'/>">이미지 파일 업로드 폼</a><br>
		<a href="<c:url value='/audioFileUploadForm'/>">오디오 업로드 폼</a><br>
		<a href="<c:url value='/recordFileUploadForm'/>">녹음 업로드 폼</a><br>
